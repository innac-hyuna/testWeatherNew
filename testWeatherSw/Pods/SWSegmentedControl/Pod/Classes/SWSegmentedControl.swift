...
open class SWSegmentedControl: UIControl {
    ...
    @IBInspectable open var font: UIFont = UIFont.systemFont(ofSize: UIFont.systemFontSize) // Wait for a day UIFont will be inspectable
    ...
    fileprivate func configureButton(_ button: UIButton) {
        ...
        button.setTitleColor(self.colorToUse(self.titleColor), for: UIControlState())
